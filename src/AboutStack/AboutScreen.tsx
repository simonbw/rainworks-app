...
/**
 * Simple screen to display some text to users.
 */
    ...
    <ScrollView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <Text style={styles.paragraph}>
          ...
          entirely, please report the rainwork so we can update it's status.
          This user-based reporting system helps us keep this app up-to-date.
        </Text>
        <Text style={styles.paragraph}>
