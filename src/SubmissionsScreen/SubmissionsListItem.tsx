...
import { ApprovalStatus } from "../DetailsView/ApprovalStatus";
...
function SubmissionsListItem({ navigation, rainwork }: Props) {
  return (
    <TouchableHighlight
      activeOpacity={0.9}
      onPress={() =>
        navigation.navigate(SUBMISSION_DETAILS_SCREEN, { rainwork })
      }
    >
      <View style={styles.listItem}>
        ...
        <View style={styles.main}>
          ...
          <Text
            style={[styles.statusText, styles[rainwork["approval_status"]]]}
          >
